    ...
    provider_calls.append(
        {
            ...
            "status": "ok",
            "input_path": artifact_reference(source),
...
def _configuration_dict(config: AnalysisConfig) -> dict[str, Any]:
    ...
    # The Python result object carries the real runtime path. Public JSON uses
    # the conventional current-artifact-directory marker so it remains
    # portable and does not disclose host-specific directory structure.
    payload["output_dir"] = "."
